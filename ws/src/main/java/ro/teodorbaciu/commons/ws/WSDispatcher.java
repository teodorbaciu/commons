...
public class WSDispatcher {
	...
	throws ServletException, IOException {
		...
		if( StringUtils.isEmpty(moduleName)) {
			response.sendError(HttpServletResponse.SC_PRECONDITION_FAILED, "[" + name + "]: " + "Please specify the 'module' http request parameter !");
			return;
		}
		...
		if( module == null ) {
			response.sendError(HttpServletResponse.SC_PRECONDITION_FAILED, "[" + name + "]: " + "Could not find module with name '" + moduleName + "' !");
			return;
		}
